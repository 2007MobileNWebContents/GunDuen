...
<body>
    ...
    <div>
        <form action="/driver/findid" name="driverIdFindInfo" method="post" onsubmit="return subChk();" style="width: 400px; margin: 0 auto;">
             <table>
            	<tr>
            		<td><a href="/index.jsp"><img src="../img/MainPageImg/gunduen.png" style="width: 250px; height: 150px;"></a></td>
            	</tr>
            	<tr>
            		<td><h2>기사 아이디 찾기</h2></td>
            	</tr>
            	<tr>
            	...
            	<tr>
            		<td style="float: left;">
            			<label for="driverEmail">이메일</label>
            		</td>
            	</tr>
            	<tr>
            		<td>
            			<input type="text" id="driverEmail" name="driverEmail" class="form-control" placeholder="이메일">
            		</td>
            	</tr>
            	<tr>
            		<td>&nbsp;</td>
