...
<script>
	...
	function pValue(){
        ...
        document.getElementById("phoneNum").value = opener.document.userInfo.firstPhone.value+"-"+opener.document.userInfo.secondPhone.value+"-"+opener.document.userInfo.thirdPhone.value;
    ...
    function sendCheckValue(){
        ...
        if(firstPhone != '010' && firstPhone != '016' && firstPhone != '017' && firstPhone != '019'){
        	...
        	history.back();
             ...
             opener.document.userInfo.firstPhone.value = firstPhone;
             opener.document.userInfo.secondPhone.value = secondPhone;
             opener.document.userInfo.thirdPhone.value = thirdPhone;
             
             opener.document.userInfo.secondPhone.readOnly = true;
             opener.document.userInfo.thirdPhone.readOnly = true;
             if (opener != null) {
                 opener.chkForm = null;
                 self.close();
             }
...
<div id="wrap">
    <br>
    <b><font color="gray" id="title" style="font-size: 1.6em;">휴대폰번호 중복체크</font></b>
    <hr size="1" width="460">
    <br>
        ...
        <div class="col-xs-2"></div>
		 ...
		 <div class="col-xs-4"> <input type="button" value="중복확인" class="btn btn-default" onclick="phoneCheck()" id="chk" style="float: left;"></div>
